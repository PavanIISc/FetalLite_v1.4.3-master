...
//		long T1 = System.currentTimeMillis();
		...
		double[][] aLeftSingMatrix = mMatrixFunctions.multiply(iA, mMatrixFunctions.multiply(aEigenVectorM, aEValueInv));
		...
		double[][] aApprox = mMatrixFunctions.multiply(aLeftSingularVectorFinal,
				mMatrixFunctions.multiply(aSingularValueFinal, mMatrixFunctions.transpose(aRightSIngularVectorFinal)));
