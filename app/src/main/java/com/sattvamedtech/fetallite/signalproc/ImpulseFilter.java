...
public class ImpulseFilter {
	...
	public double[][] impulseFilterParallel(double[][] input) throws Exception{
	 ...
	 */
	public void setBoundryCondition() throws Exception{
	...
	public void impulseElimination(double[] iInput, int iThreshold, int iWindow, int iPercentile) throws Exception{
	 ...
	 */
	public double[] medianFilter1D(double[] iInputMedian1D, int iWindowIn) throws Exception{
		...
		double[] aExtensionInitial = new double[iWindowIn];
		double[] aExtensionFinal = new double[iWindowIn];
		for (int i = 0; i < iWindowIn; i++) {
			aExtensionInitial[i] = iInputMedian1D[i];
			aExtensionFinal[i] = iInputMedian1D[aLengthInput - (iWindowIn - i)];
		}
