...
public class TestFragment extends Fragment implements View.OnClickListener, OnChartValueSelectedListener, PlotInterface {
    ...
    private TextView mTvFhr, mTvFhrLabel, mTvMhr, mTvMhrLabel, mTvGestationalAge, mTvAccelerations, mTvDecelerations, mTvName, mTvPatientId, mTvTestTime, mTvMinSecLabel, mTvTestTimeLabel, mTvStopTest, mTvSendSmsLabel,mTvTestDate;
...
//                Intent testAgain = new Intent(getContext(), NewTestDialog.class);
//                startActivity(testAgain);
            Logger.logInfo("Test fragment: ", "newTest button click");
            newTest();
    ...
    // 06/07/2017: Added tv for date and fetching date from mTest object here. Only visible for view data.
    // Different input variables for fetching from database and immediately after test.
    ...
    private void newTest() {
        Logger.logInfo("Test fragment: ", "inside new Test");
